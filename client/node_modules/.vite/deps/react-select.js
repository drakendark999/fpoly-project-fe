...
import {
  ...
  keyframes
<<<<<<< HEAD
} from "./chunk-QOEUH7IF.js";
import {
  _extends,
  _objectWithoutPropertiesLoose
} from "./chunk-KCYS44RR.js";
...
=======
} from "./chunk-PV4NRDHY.js";
import {
  _extends,
  _objectWithoutPropertiesLoose
} from "./chunk-ZHN7VOXI.js";
...
function getCssDimensions(element) {
  ...
  let width = parseFloat(css5.width);
  let height = parseFloat(css5.height);
...
var LiveRegion = function LiveRegion2(props) {
  ...
  return jsx(import_react5.Fragment, null, jsx(A11yText, {
    id
  ...
  _createClass(Select2, [{
    ...
    value: (
      ...
      function renderInput() {
        ...
        if (!isSearchable) {
          return React.createElement(DummyInput, _extends({
            id,
        ...
        return React.createElement(Input3, _extends({}, commonProps, {
          autoCapitalize: "none",
          autoComplete: "off",
          autoCorrect: "off",
          id,
    ...
    value: function renderPlaceholderOrValue() {
      ...
      if (!this.hasValue() || !controlShouldRenderValue) {
        return inputValue ? null : React.createElement(Placeholder3, _extends({}, commonProps, {
          key: "placeholder",
          isDisabled,
          isFocused,
          innerProps: {
      ...
      if (isMulti) {
        return selectValue.map(function(opt, index2) {
          ...
          return React.createElement(MultiValue3, _extends({}, commonProps, {
            components: {
      ...
      return React.createElement(SingleValue3, _extends({}, commonProps, {
        data: singleValue,
        isDisabled
    ...
    value: function renderClearIndicator() {
      ...
      return React.createElement(ClearIndicator3, _extends({}, commonProps, {
        innerProps,
        isFocused
      }));
    }
    ...
    value: function renderLoadingIndicator() {
      ...
      return React.createElement(LoadingIndicator3, _extends({}, commonProps, {
        innerProps,
        isDisabled,
        isFocused
      }));
    ...
    value: function renderIndicatorSeparator() {
      ...
      var isFocused = this.state.isFocused;
      return React.createElement(IndicatorSeparator3, _extends({}, commonProps, {
        isDisabled,
        isFocused
      }));
    }
    ...
    value: function renderDropdownIndicator() {
      ...
      return React.createElement(DropdownIndicator3, _extends({}, commonProps, {
        innerProps,
        isDisabled,
        isFocused
      }));
    ...
    value: function renderMenu() {
      ...
      var render = function render2(props, id) {
        ...
        return React.createElement(Option3, _extends({}, commonProps, {
          innerProps,
          data,
          isDisabled,
          isSelected,
      ...
      if (this.hasOptions()) {
        menuUI = this.getCategorizedOptions().map(function(item) {
          if (item.type === "group") {
            ...
            return React.createElement(Group3, _extends({}, commonProps, {
              key: groupId,
              data: _data,
              options: options2,
        ...
        if (_message === null)
          return null;
        menuUI = React.createElement(NoOptionsMessage3, commonProps, _message);
      }
      ...
      var menuElement = React.createElement(MenuPlacer, _extends({}, commonProps, menuPlacementProps), function(_ref4) {
        var ref = _ref4.ref, _ref4$placerProps = _ref4.placerProps, placement = _ref4$placerProps.placement, maxHeight = _ref4$placerProps.maxHeight;
        return React.createElement(Menu3, _extends({}, commonProps, menuPlacementProps, {
          innerRef: ref,
          innerProps: {
          ...
          return React.createElement(MenuList3, _extends({}, commonProps, {
      ...
      return menuPortalTarget || menuPosition === "fixed" ? React.createElement(MenuPortal3, _extends({}, commonProps, {
    ...
    value: function renderFormField() {
      ...
      if (required && !this.hasValue()) {
        return React.createElement(RequiredInput, {
          name,
    ...
    value: function renderLiveRegion() {
      ...
      return React.createElement(LiveRegion, _extends({}, commonProps, {
    ...
    value: function render() {
      ...
      return React.createElement(SelectContainer3, _extends({}, commonProps, {
        className,
        innerProps: {
          id,
        ...
        isDisabled,
        isFocused
      }), this.renderLiveRegion(), React.createElement(Control3, _extends({}, commonProps, {
        ...
        isFocused,
        menuIsOpen
      }), React.createElement(ValueContainer3, _extends({}, commonProps, {
        isDisabled
      }), this.renderPlaceholderOrValue(), this.renderInput()), React.createElement(IndicatorsContainer3, _extends({}, commonProps, {
        isDisabled
...
var StateManagedSelect = (0, import_react7.forwardRef)(function(props, ref) {
  var baseSelectProps = useStateManager(props);
  return React2.createElement(Select, _extends({
    ref
  }, baseSelectProps));
});
var NonceProvider = function(_ref3) {
  var nonce = _ref3.nonce, children = _ref3.children, cacheKey = _ref3.cacheKey;
  var emotionCache = (0, import_react7.useMemo)(function() {
    return emotion_cache_browser_esm_default({
      key: cacheKey,
      nonce
    });
  }, [cacheKey, nonce]);
  return React2.createElement(CacheProvider, {
    value: emotionCache
  }, children);
};
...
export {
  ...
  components,
  createFilter,
  react_select_esm_default as default,
  defaultTheme,
  mergeStyles,
  useStateManager
};
